...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/version.mjs
var VERSION = "4.30.0";

// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/_shims/registry.mjs
var auto = false;
var kind = void 0;
var fetch2 = void 0;
var Request2 = void 0;
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/_shims/MultipartBody.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/_shims/web-runtime.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/_shims/index.mjs
if (!kind)
  setShims(getRuntime(), { auto: true });

// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/error.mjs
var error_exports = {};
...
var APIError = class _APIError extends OpenAIError {
  constructor(status, error, message, headers) {
    super("".concat(_APIError.makeMessage(status, error, message)));
    this.status = status;
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/streaming.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/uploads.mjs
...
async function getBytes(value) {
  ...
  value instanceof ArrayBuffer) {
    ...
    throw new Error("Unexpected data type: ".concat(typeof value, "; constructor: ").concat((_a2 = value == null ? void 0 : value.constructor) == null ? void 0 : _a2.name, "; props: ").concat(propsForError(value)));
  }
  return parts;
}
...
var addFormValue = async (form, key, value) => {
  ...
  if (typeof value === "string" || typeof value === "number" || typeof value === "boolean") {
    ...
    await Promise.all(Object.entries(value).map(([name, prop]) => addFormValue(form, "".concat(key, "[").concat(name, "]"), prop)));
  } else {
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/core.mjs
...
var APIClient = class {
  ...
  async makeRequest(optionsInput, retriesRemaining) {
    ...
    if (!response.ok) {
      if (retriesRemaining && this.shouldRetry(response)) {
        const retryMessage2 = "retrying, ".concat(retriesRemaining, " attempts remaining");
        debug("response (error; ".concat(retryMessage2, ")"), response.status, url, responseHeaders);
  ...
  stringifyQuery(query) {
    return Object.entries(query).filter(([_, value]) => typeof value !== "undefined").map(([key, value]) => {
      ...
      throw new OpenAIError("Cannot stringify type ".concat(typeof value, "; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case."));
    }).join("&");
  }
...
function getBrowserInfo() {
  ...
  for (const { key, pattern } of browserPatterns) {
    ...
    if (match) {
      ...
      return { browser: key, version: "".concat(major, ".").concat(minor, ".").concat(patch) };
    }
  }
  return null;
}
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/pagination.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resource.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/chat/completions.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/chat/chat.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/audio/speech.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/audio/transcriptions.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/audio/translations.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/audio/audio.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/assistants/files.mjs
var Files = class extends APIResource {
  ...
  create(assistantId, body, options) {
    return this._client.post("/assistants/".concat(assistantId, "/files"), {
      body,
      ...options,
  ...
  retrieve(assistantId, fileId, options) {
    return this._client.get("/assistants/".concat(assistantId, "/files/").concat(fileId), {
      ...options,
      headers: { "OpenAI-Beta": "assistants=v1", ...options == null ? void 0 : options.headers }
    });
  }
  list(assistantId, query = {}, options) {
    ...
    return this._client.getAPIList("/assistants/".concat(assistantId, "/files"), AssistantFilesPage, {
      query,
      ...options,
      headers: { "OpenAI-Beta": "assistants=v1", ...options == null ? void 0 : options.headers }
    });
  ...
  del(assistantId, fileId, options) {
    return this._client.delete("/assistants/".concat(assistantId, "/files/").concat(fileId), {
      ...options,
      headers: { "OpenAI-Beta": "assistants=v1", ...options == null ? void 0 : options.headers }
    });
  }
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/assistants/assistants.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/RunnableFunction.mjs
function isRunnableFunctionWithParse(fn) {
  return typeof fn.parse === "function";
}

// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/chatCompletionUtils.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/AbstractChatCompletionRunner.mjs
...
var AbstractChatCompletionRunner = class {
  ...
  async _runFunctions(completions, params, options) {
    ...
    for (let i = 0; i < maxChatCompletions; ++i) {
      ...
      if (!fn) {
        const content2 = "Invalid function_call: ".concat(JSON.stringify(name), ". Available options are: ").concat(functions.map((f) => JSON.stringify(f.name)).join(", "), ". Please try again");
        this._addMessage({ role, name, content: content2 });
        continue;
      } else if (singleFunctionToCall && singleFunctionToCall !== name) {
        const content2 = "Invalid function_call: ".concat(JSON.stringify(name), ". ").concat(JSON.stringify(singleFunctionToCall), " requested. Please try again");
        this._addMessage({ role, name, content: content2 });
        continue;
      }
      let parsed;
  ...
  async _runTools(completions, params, options) {
    ...
    for (let i = 0; i < maxChatCompletions; ++i) {
      ...
      for (const tool_call of message.tool_calls) {
        ...
        const fn = functionsByName[name];
        if (!fn) {
          const content2 = "Invalid tool_call: ".concat(JSON.stringify(name), ". Available options are: ").concat(tools.map((f) => JSON.stringify(f.function.name)).join(", "), ". Please try again");
          this._addMessage({ role, tool_call_id, content: content2 });
          continue;
        } else if (singleFunctionToCall && singleFunctionToCall !== name) {
          const content2 = "Invalid tool_call: ".concat(JSON.stringify(name), ". ").concat(JSON.stringify(singleFunctionToCall), " requested. Please try again");
          this._addMessage({ role, tool_call_id, content: content2 });
          continue;
        }
        let parsed;
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/ChatCompletionRunner.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/ChatCompletionStream.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/ChatCompletionStreamingRunner.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/chat/completions.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/chat/chat.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/AbstractAssistantStreamRunner.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/lib/AssistantStream.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/threads/messages/files.mjs
var Files2 = class extends APIResource {
  /**
   * Retrieves a message file.
   */
  retrieve(threadId, messageId, fileId, options) {
    return this._client.get("/threads/".concat(threadId, "/messages/").concat(messageId, "/files/").concat(fileId), {
      ...options,
      headers: { "OpenAI-Beta": "assistants=v1", ...options == null ? void 0 : options.headers }
    });
  }
  list(threadId, messageId, query = {}, options) {
    ...
    return this._client.getAPIList("/threads/".concat(threadId, "/messages/").concat(messageId, "/files"), MessageFilesPage, {
      query,
      ...options,
      headers: { "OpenAI-Beta": "assistants=v1", ...options == null ? void 0 : options.headers }
    });
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/threads/messages/messages.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/threads/runs/steps.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/threads/runs/runs.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/threads/threads.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/beta/beta.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/completions.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/embeddings.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/files.mjs
var Files3 = class extends APIResource {
  ...
  content(fileId, options) {
    return this._client.get("/files/".concat(fileId, "/content"), { ...options, __binaryResponse: true });
  }
  /**
   * Returns the contents of the specified file.
   *
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/fine-tuning/jobs.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/fine-tuning/fine-tuning.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/images.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/models.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/resources/moderations.mjs
...
// ../node_modules/.pnpm/openai@4.30.0/node_modules/openai/index.mjs
var _a;
...
// src/predict.ts
var predict = (o, prompt) => {
  const operationEvents = new Subject();
