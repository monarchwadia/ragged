        ...
        expect(response).toMatchInlineSnapshot(`
          {
            "history": [
              {
                "text": "The first image is an emoji with heart-shaped eyes and a smiling mouth, commonly known as the "heart eyes" emoji. It is typically used to convey love, adoration, or extreme happiness.

          The second image is a gradient of colors transitioning from blue at the bottom left corner to black at the top left corner, and from black at the top left corner to orange at the top right corner. The gradient forms a smooth blend of these colors.",
                "type": "bot",
              },
            ],
          }
